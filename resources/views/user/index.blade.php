...
<x-app-layout>
    <x-slot name="header">
        ...
        <a class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold mb-2 py-2 px-4 border border-purple-600  rounded cursor-pointer hover:bg-purple-600 hover:text-white text-purple-600 ease-linear transition-all duration-150" href="{{route('user.create')}}">
            Crear
        </a>
        <form action="{{route('user.index')}}" method="get">
            <div class="mt-6 mb-3">
                <label for="search" class="text-sm font-medium text-gray-900 block mb-2">buscar registro por: <strong>nombre,email</strong></label>
                            ...
                            @forelse ($users as $user)
                                <tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
                                    ...
                                    <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                                        ...
                                        <a class="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 border border-green-500 rounded" href="{{route('user.show',$user->id)}}">ver</a>
                                        <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 border border-blue-500 rounded" href="{{route('user.edit',$user->id)}}">Editar</a>
